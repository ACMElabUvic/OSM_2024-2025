...
```{r script_parameters}
my_netdrive <- 'Z:/1.Resources/2.Arrays/Alberta/OSM/2024-2025' # the path to the netdrive on your device
...
with_dir(new = my_netdrive,
  ...
  OSM_2024_deploy_raw <- read_csv('./4. Deployment Data/OSM_2024_Deployment_Data.csv',
...
write_csv(OSM_2024_deploy,
          './data/processed/OSM_deployment_2024.csv')
...
OSM_2024_deploy <- read_csv('data/processed/OSM_deployment-dates_2024.csv') %>% 
...
if(nrow(OSM_2024_error_metadata) == 0){
  ...
  writexl::write_xlsx(OSM_2024_error_metadata, "./data/processed/OSM_2024_error_metadata.xlsx", format_headers = TRUE)
...
writexl::write_xlsx(OSM_2024_error_image, "./data/processed/OSM_2024_error_image.xlsx", format_headers = TRUE)
...
if(nrow(OSM_2024_error_datemismatch) == 0){
  ...
  writexl::write_xlsx(OSM_2024_error_datemismatch, "./data/processed/OSM_2024_error_datemismatch.xlsx", format_headers = TRUE)
...
write.csv(OSM_2024_data_clean %>% mutate(datetime = paste0(" ", format(datetime, format = "%Y-%m-%d %H:%M:%S"))), 
          file = 'data/processed/OSM_timelapse_2024.csv',
          na = "", row.names = FALSE)
